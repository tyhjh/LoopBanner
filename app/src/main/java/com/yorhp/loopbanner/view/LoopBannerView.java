package com.yorhp.loopbanner.view;
...
public class LoopBannerView extends FrameLayout implements View.OnTouchListener {
    ...
    //跳转动画时间
    private static int MOVE_TIME = 500;
    //手指翻页速度上限,达到即翻页
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        reSetBanner();
        imageViews[0].setImageResource(R.drawable.ic_point_selected);
    ...
    private void moveAnim(int toX, int moveTime) {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                initPoint();
                if (curItem == 1) {
                    imageViews[imageViews.length].setImageResource(R.drawable.ic_point_selected);
                } else if (curItem == ITEM_COUNT) {
                    imageViews[0].setImageResource(R.drawable.ic_point_selected);
                } else {
                    imageViews[curItem - 2].setImageResource(R.drawable.ic_point_selected);
                }
